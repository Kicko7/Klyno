...
import { teamChatMessages, teamChats, users, userSubscriptions } from './schemas';

const connectionString = process.env.DATABASE_URL!;

const client = postgres(connectionString);
export const db = drizzle(client, { schema: { credits, userCredits, creditTransactions, teamChatMessages, teamChats, users ,userSubscriptions} });
